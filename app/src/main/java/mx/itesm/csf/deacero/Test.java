...
public class Test extends AppCompatActivity {
    ...
    String f,mes,anio;
    String url = "http://ubiquitous.csf.itesm.mx/~pddm-1020736/content/Deacero/Servicios/servicio.mes-anio.php?tabla=Entrada";
    ...
    public void addListenerOnButton() {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                url = "http://ubiquitous.csf.itesm.mx/~pddm-1020736/content/Deacero/Servicios/servicio.mes-anio.php?tabla=Entrada";
                ...
                Toast.makeText(Test.this,
                        "OnClickListener : " +
                                "\nSpinner 1 : " + String.valueOf(spinner1.getSelectedItemPosition()) +
